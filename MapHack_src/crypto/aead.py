...
from MapHack_src.crypto import util
from MapHack_src.crypto import hkdf
from MapHack_src.common import ord, chr
...
class AeadCryptoBase(object):
    """
    Handles basic aead process of MapHack_src protocol
